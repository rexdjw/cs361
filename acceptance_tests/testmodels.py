...
class Course(models.Model):
    ...
    TAs = models.ManyToOneRel(TA) #models.ForeignKey(TA, on_delete=models.CASCADE, repeated = True)
    labs = models.ManyToOneRel(Lab) #models.ForeignKey(Lab, on_delete=models.CASCADE, repeated = True)