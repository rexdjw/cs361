...
from pip._internal.utils.misc import (
    ...
    display_path, dist_in_site_packages, dist_in_Userssite, ensure_dir,
...
class InstallRequirement(object):
    ...
    def uninstall(self, auto_confirm=False, verbose=False,
        ...
        """
        if not self.check_if_exists(use_Users_site):
    ...
    def install(self, install_options, global_options=None, root=None,
                ...
                use_Users_site=False, pycompile=True):
        ...
        if self.is_wheel:
            ...
            self.move_wheel_files(
                ...
                use_Users_site=use_Users_site, pycompile=pycompile,
            )
        ...
        if self.isolated:
            global_options = global_options + ["--no-Users-cfg"]
    ...
    def check_if_exists(self, use_Users_site):
        ...
        try:
            ...
            if use_Users_site:
                if dist_in_Userssite(existing_dist):
    ...
    def move_wheel_files(self, wheeldir, root=None, home=None, prefix=None,
                         warn_script_location=True, use_Users_site=False,
                         pycompile=True):
        move_wheel_files(
            self.name, self.req, wheeldir,
            Users=use_Users_site,
            home=home,
            root=root,
            prefix=prefix,
            pycompile=pycompile,
