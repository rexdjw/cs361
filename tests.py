...
class TestUser(TestCase):
    ...
    def test_to_string0(self):
        ...
        self.assertEqual(self.user.printRoles(), "")
    ...
    def test_to_string1(self):
        ...
        self.assertEqual(self.user.printRoles(), "[TA] ")
    ...
    def test_to_string2(self):
        ...
        self.assertEqual(self.user.printRoles(), "[Supervisor] [Instructor] ")
        self.assertEqual(str(self.user), "User username has [Supervisor] [Instructor] role permissions.")

    def test_get_absolute_url0(self):
        Users.create("username", "password", 0).save()
        self.user = Users.objects.get(username="username")

        self.assertEqual(self.user.get_absolute_url(), "/contactInfo/username/")

    def test_get_absolute_url1(self):
        Users.create("username1", "password", 0).save()
        self.user = Users.objects.get(username="username1")

        self.assertNotEqual(self.user.get_absolute_url(), "/contactInfo/username/")
